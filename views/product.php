<div class="container">
    <div class="productconteiner">
        ...
        <?php if ($_SESSION['id'] == 1) : ?>
            ...
            <form class="productUpdate" action="/?c=catalog&a=save&id=<?= $item['id'] ?>" method="post">
                <input hidden type="text" name='id' value="<?= $item['id'] ?>">
                <input class='newProductInput' type="text" name='name' value="" placeholder="Название товара">
